...
class WorkflowControllerAutoTests(unittest.TestCase):
    def make_settings(self, *, sexing_verification_passes: int = 3) -> OperatorSettings:
        return OperatorSettings(
            ...
            sexing_verification_passes=sexing_verification_passes,
    ...
    def build_controller(self, captures, sexing_results, *, sexing_verification_passes: int = 3) -> WorkflowController:
        FakeChannel.queued_captures = captures
        FakeSexing.queued_results = sexing_results
        settings = self.make_settings(sexing_verification_passes=sexing_verification_passes)
    ...
    def test_auto_flow_skips_stuck_location_after_two_pickup_misses(self):
        ...
        sexing_results = [
            {"captured_at": "s1", "label": "UNCERTAIN", "confidence": 0.0, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s2", "label": "UNCERTAIN", "confidence": 0.0, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s3", "label": "UNCERTAIN", "confidence": 0.0, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s4", "label": "UNCERTAIN", "confidence": 0.0, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s5", "label": "UNCERTAIN", "confidence": 0.0, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s6", "label": "UNCERTAIN", "confidence": 0.0, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s7", "label": "male", "confidence": 0.96, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
            {"captured_at": "s8", "label": "male", "confidence": 0.95, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
            {"captured_at": "s9", "label": "male", "confidence": 0.94, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
        ]
    ...
    def test_auto_flow_routes_uncertain_fly_to_junk_when_source_disappears(self):
        ...
        sexing_results = [
            {"captured_at": "s1", "label": "UNCERTAIN", "confidence": 0.12, "image_path": "", "detail": "LOW_CONF", "uncertain": True, "count": 1},
            {"captured_at": "s2", "label": "UNCERTAIN", "confidence": 0.11, "image_path": "", "detail": "LOW_CONF", "uncertain": True, "count": 1},
            {"captured_at": "s3", "label": "UNCERTAIN", "confidence": 0.10, "image_path": "", "detail": "LOW_CONF", "uncertain": True, "count": 1},
        ]
        controller = self.build_controller(captures, sexing_results)
        controller.start_auto_flow()
        controller._task_thread.join(timeout=3)
    ...
    def test_count_zero_does_not_route_to_junk_even_if_occupied_flag_is_set(self):
        captures = [
            {
                "captured_at": "t0",
                "count": 1,
        ...
        sexing_results = [
            {
                ...
                "confidence": 0.0,
                "image_path": "",
                "detail": "CHAMBER_OCCUPIED_UNCOUNTED",
                "uncertain": True,
                "occupied": True,
                "count": 0,
                "errors": ["CHAMBER_EMPTY", "CHAMBER_OCCUPIED_UNCOUNTED"],
            },
        ]
        controller = self.build_controller(captures, sexing_results)
        controller.start_auto_flow()
        ...
        self.assertEqual(len(controller.hardware.drop_history), 0)
        self.assertIn("no specimen remained in the chamber", snapshot.sexing.detail.lower())
    ...
    def test_uncertain_pickup_miss_does_not_route_to_junk_vial(self):
        ...
        sexing_results = [
            {"captured_at": "s1", "label": "UNCERTAIN", "confidence": 0.02, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s2", "label": "UNCERTAIN", "confidence": 0.02, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s3", "label": "UNCERTAIN", "confidence": 0.02, "image_path": "", "detail": "NO_PROBS", "uncertain": True, "count": 1},
            {"captured_at": "s4", "label": "male", "confidence": 0.97, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
            {"captured_at": "s5", "label": "male", "confidence": 0.96, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
            {"captured_at": "s6", "label": "male", "confidence": 0.95, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
        ]
        controller = self.build_controller(captures, sexing_results)
        controller.start_auto_flow()
        controller._task_thread.join(timeout=3)
    ...
    def test_auto_flow_rejects_mismatched_second_sex_to_junk(self):
        ...
        controller = self.build_controller(captures, sexing_results, sexing_verification_passes=2)
        controller.start_auto_flow()
        controller._task_thread.join(timeout=3)
        snapshot = controller.snapshot()
    ...
    def test_auto_flow_three_pass_majority_routes_with_two_matching_votes(self):
        captures = [
            {
                "captured_at": "t0",
                "count": 1,
        ...
        sexing_results = [
            {"captured_at": "s1", "label": "male", "confidence": 0.98, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
            {"captured_at": "s2", "label": "female", "confidence": 0.93, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
            {"captured_at": "s3", "label": "male", "confidence": 0.97, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
        ]
        controller = self.build_controller(captures, sexing_results, sexing_verification_passes=3)
        controller.start_auto_flow()
        controller._task_thread.join(timeout=3)
        snapshot = controller.snapshot()
        self.assertEqual(snapshot.vials[1].current_count, 1)
        self.assertIn("majority vote male (2/3 passes)", snapshot.sexing.detail.lower())

    def test_auto_flow_single_pass_mode_routes_without_resex(self):
        captures = [
            {
                "captured_at": "t0",
                "count": 1,
        ...
        sexing_results = [
            {"captured_at": "s1", "label": "female", "confidence": 0.96, "image_path": "", "detail": "ok", "uncertain": False, "count": 1},
        ]
        controller = self.build_controller(captures, sexing_results, sexing_verification_passes=1)
        controller.start_auto_flow()
        controller._task_thread.join(timeout=3)
        snapshot = controller.snapshot()
        self.assertEqual(snapshot.vials[2].current_count, 1)
        self.assertIn("single-pass classification returned female", snapshot.sexing.detail.lower())
