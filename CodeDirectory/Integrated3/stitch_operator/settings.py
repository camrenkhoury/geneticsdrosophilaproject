...
class OperatorSettings:
    ...
    sexing_capture_width: int = 2028
    sexing_capture_height: int = 1520
    sexing_capture_awbgains: str = "3.0,0.9"
    sexing_capture_roi: str = "0,0,1,1"
    sexing_uncertain_threshold: float = 0.70
    sexing_error_corner_sample_px: int = 20
    sexing_error_bg_tolerance: int = 65
    sexing_error_open_kernel_size: int = 3
    sexing_error_close_kernel_size: int = 11
    sexing_error_erode_kernel_size: int = 11
    sexing_error_erode_iterations: int = 9
    sexing_error_single_fly_min_frac: float = 0.001
    sexing_error_single_fly_max_area_px: int = 40000
    ...
    vacuum_release_settle_s: float = 0.25
    classification_delay_s: float = config.CLASSIFICATION_DELAY
    sexing_verification_passes: int = 3
    chamber_reacquire_pick_delay_s: float = 0.9
    chamber_clear_retry_attempts: int = 2
    auto_max_pick_attempts_per_location: int = 2
    channel_position_match_tolerance_mm: float = 4.0
    auto_uncertain_to_junk: bool = True
    auto_fallback_to_junk_when_full: bool = True
    ...
    def default(cls) -> "OperatorSettings":
        vial_defs = [
            VialDefinition(
                vial_id=vial_id,
                label=str(spec.get("label", vial_id)),
    ...
    def from_dict(cls, data: Optional[Dict[str, Any]]) -> "OperatorSettings":
        ...
        for field_name in [
            ...
            "sexing_capture_width",
            "sexing_capture_height",
            "sexing_capture_awbgains",
            "sexing_capture_roi",
            "sexing_uncertain_threshold",
            "sexing_error_corner_sample_px",
            "sexing_error_bg_tolerance",
            "sexing_error_open_kernel_size",
            "sexing_error_close_kernel_size",
            "sexing_error_erode_kernel_size",
            "sexing_error_erode_iterations",
            "sexing_error_single_fly_min_frac",
            "sexing_error_single_fly_max_area_px",
            ...
            "vacuum_pick_delay_s",
            "vacuum_drop_delay_s",
            "vacuum_release_settle_s",
            "classification_delay_s",
            "sexing_verification_passes",
            "chamber_reacquire_pick_delay_s",
            "chamber_clear_retry_attempts",
            "auto_max_pick_attempts_per_location",
            "channel_position_match_tolerance_mm",
            "auto_uncertain_to_junk",
            "auto_fallback_to_junk_when_full",
