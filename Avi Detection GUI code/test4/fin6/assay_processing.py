...
from box_upload import BoxUploadError, upload_run_artifacts
...
def _deduplicate_crossings(candidates: Sequence[CrossingCandidate]) -> Tuple[pd.DataFrame, Dict[int, int]]:
    ...
    crossings_df = pd.DataFrame(accepted_rows)
...
def process_assay_run(
    ...
    *,
    ...
    upload_requested = bool(profile.box_upload.enabled and profile.box_upload.upload_after_processing)
