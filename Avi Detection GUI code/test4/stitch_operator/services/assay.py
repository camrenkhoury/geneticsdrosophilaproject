...
from assay_tracking import calibrate_assay_interactive, load_assay_calibration, preview_assay_frame  # noqa: E402
...
class AssayService:
    ...
    def upload_last(self, logger: Optional[Callable[[str], None]] = None) -> Dict[str, Any]:
        ...
        return manual_upload_run(run_dir, self.profile.box_upload, artifact_mode=self.profile.box_upload.artifact_mode, logger=logger)
