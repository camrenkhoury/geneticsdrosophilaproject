...
- Legacy `box_login.py` is restored.
- It writes Box OAuth tokens to `/home/team8/z.avi_assay_tests/assayfinal/box_tokens.json`.
- The GUI defaults now point the assay Box upload settings at that same tokens path.
