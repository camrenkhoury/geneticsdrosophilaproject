...
class OperatorApp(tk.Tk):
    ...
    def _build_workflow_page(self, parent) -> tk.Frame:
        ...
        self._action_button(controls, "START AUTO", lambda: self.controller.start_auto_flow(), width=16).pack(anchor="w", pady=(10, 8))
        self._action_button(controls, "STOP", lambda: self.controller.stop_current_task(), primary=False, width=16).pack(anchor="w")
        ...
        self._image_panel(previews, "workflow_channel", "Channel view", width=760, height=360).grid(
            row=0, column=0, sticky="nsew", padx=(0, 10)
        )
        self._image_panel(previews, "workflow_sexing", "Sexing chamber", width=760, height=360).grid(
