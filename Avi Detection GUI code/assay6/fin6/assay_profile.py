...
class AnalysisSettings:
    ...
    tracking_mode: str = "stitch"
    use_mask_blobs_as_flies: bool = True

    @classmethod
    def from_dict(cls, data: Optional[Dict[str, Any]]) -> "AnalysisSettings":
        payload = dict(data or {})
        tracking_mode = str(payload.get("tracking_mode", payload.get("tracker_mode", "stitch")) or "stitch").strip().lower()
        ...
        return cls(
            ...
            use_mask_blobs_as_flies=bool(payload.get("use_mask_blobs_as_flies", payload.get("mask_blob_mode", True))),
        )
...
class OutputSettings:
    ...
    save_preview_snapshots: bool = False
    ...
    def from_dict(cls, data: Optional[Dict[str, Any]]) -> "OutputSettings":
        ...
        return cls(
            ...
            save_preview_snapshots=bool(payload.get("save_preview_snapshots", False)),
...
class BoxUploadSettings:
    ...
    tokens_file: str = ""
    config_file: str = ""
    upload_after_processing: Optional[bool] = None
    upload_after_recording: Optional[bool] = None
    upload_backgrounds: Optional[bool] = None
    ...
    def from_dict(cls, data: Optional[Dict[str, Any]]) -> "BoxUploadSettings":
        payload = dict(data or {})
        return cls(
            enabled=None if "enabled" not in payload else bool(payload.get("enabled")),
            ...
            upload_after_processing=None if "upload_after_processing" not in payload else bool(payload.get("upload_after_processing")),
            upload_after_recording=None if "upload_after_recording" not in payload else bool(payload.get("upload_after_recording")),
            upload_backgrounds=None if "upload_backgrounds" not in payload else bool(payload.get("upload_backgrounds")),
