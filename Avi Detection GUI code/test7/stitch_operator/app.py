...
class OperatorApp(tk.Tk):
    ...
    def _build_workflow_page(self, parent) -> tk.Frame:
        ...
        page.rowconfigure(1, weight=7, minsize=560)
        page.rowconfigure(2, weight=3, minsize=260)
        ...
        previews.columnconfigure(0, weight=3, minsize=720)
        previews.columnconfigure(1, weight=2, minsize=520)
        previews.rowconfigure(0, weight=4, minsize=280)
        previews.rowconfigure(1, weight=5, minsize=340)
        self._image_panel(previews, "workflow_channel", "Channel view", width=1280, height=280).grid(
            row=0, column=0, columnspan=2, sticky="nsew", pady=(0, 14)
        )
        self._image_panel(previews, "workflow_sexing", "Sexing chamber", width=760, height=420).grid(
            row=1, column=0, sticky="nsew", padx=(0, 10)
        )
        self._image_panel(previews, "workflow_assay", "Assay preview", width=760, height=420).grid(
    ...
    def _build_channel_page(self, parent) -> tk.Frame:
        ...
        self._image_panel(page, "channel_main", "Channel capture", width=1320, height=430).grid(row=0, column=0, sticky="nsew", padx=(0, 12))
